...
logo.setAttribute('src', siteContent["nav"]["img-src"])
  ...
  //a tag array
const navArray = Array.from(document.getElementsByTagName('a'));
...
for (let i = 0; i<navArray.length; i++){
  navArray[i].textContent = Object.values(navValues)[i];
}
...
headerText[0].innerHTML = '<h1>DOM<br>Is<br>Awesome</h1>';
...
newNav1.textContent = 'New Navigation';
const newNav2 = document.createElement('a')
newNav2.textContent = 'New New Navigation';
